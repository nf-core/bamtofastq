...
def helpMessage() {
    ...
    Other options:   
      ...
      --no_final_QC            [bool]  If specified, no quality control will be performed on extracted reads. Useful, if this is done anyways in the subsequent workflow
...
summary['Final QC'] = params.no_final_QC ? 'No' : 'Yes'
