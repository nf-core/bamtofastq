...
def helpMessage() {
    ...
    nextflow run FriederikeHanssen/bamtofastq --input '*bam' -profile docker
    ...
    Other options:
      ...
      --chr                         Only use reads mapping to a specific chromosome/region. Has to be specified as in bam: i.e chr1, chr{1..22} (gets all reads mapping to chr1 to 22), 1, "X Y", incorrect naming will lead to a potentially silent error
