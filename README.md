...
[![AWS CI](https://img.shields.io/badge/CI%20tests-full%20size-FF9900?logo=Amazon%20AWS)](https://nf-co.re/bamtofastq/results)
...
[![Get help on Slack](http://img.shields.io/badge/slack-nf--core%20%23bamtofastq-4A154B?logo=slack)](https://nfcore.slack.com/channels/bamtofastq)
...
**nf-core/bamtofastq** is a bioinformatics best-practice analysis pipeline that converts (un)mapped `.bam` files into `fq.gz` files.
...
4. Start running your own analysis!
   ...
   ```console
   nextflow run nf-core/bamtofastq --input '*.bam' --outdir <OUTDIR> -profile <docker/singularity/podman/shifter/charliecloud/conda/institute>
   ```
...
qbic-pipelines/bamtofastq was originally written by [Friederike Hanssen](https://github.com/FriederikeHanssen). It was ported to DSL2 by [Susanne Jodoin](https://github.com/SusiJo).
